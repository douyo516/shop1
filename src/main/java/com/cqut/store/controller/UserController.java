...
import com.cqut.store.controller.ex.*;
...
public class UserController extends BaseController {
    ...
    @RequestMapping("reg")
    public JsonResult<Void> reg(User user,String pwd_confirm) {
        // 调用业务对象执行注册
        userService.reg(user,pwd_confirm);
        // 返回
    ...
    */
    ...
    public JsonResult<List<User>> getAllUser(){
        ...
        return new JsonResult<>(OK,allUser);
    }
