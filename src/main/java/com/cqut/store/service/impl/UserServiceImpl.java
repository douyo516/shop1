...
public class UserServiceImpl extends ServiceImpl<UserMapper,User> implements IUserService {
    ...
    @Override
    public void reg(User user, String pwd_confirm) {
        // 根据参数user对象获取注册的用户名
        ...
        String md5Password1 = getMd5Password(user.getPassword(), salt);
        String md5Password2=getMd5Password(pwd_confirm,salt);
        if(!md5Password1.equals(md5Password2)){
            throw new UsernameDuplicateException("密码确认错误，请重新输入！");
        }
